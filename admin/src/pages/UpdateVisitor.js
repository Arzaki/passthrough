...
function UpdateVisitors() {
  function updateUser() {
    ...
    axios
      .post("http://localhost:4000/api/updateVisitor", {
        newName: newName,
        newEmail: newEmail,
      ...
      .then((response) => {
        if (response.data.msg) {
          ...
          setTimeout((window.location = "/ManageVisitors"), 5000);
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4000/api/getVisitorData", { params: { id: id } })
      .then((response) => {
